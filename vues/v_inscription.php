   ...
   <fieldset>
     <legend>Insciption</legend>
      ...
      <p>
         ...
         <input id="mdp1" type="password"  name="mdp1" size ="25" maxlength="50">
      </p>
      <p>
         <label for="mdp2">mot de passe a retaper* </label>
         <input id="mdp2" type="password"  name="mdp2" size ="25" maxlength="50">
      </p>
	  	<p>
