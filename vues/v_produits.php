<article class="container" style="margin-left: 200px; width: 90%;">	
	<h3 class="text-center" style="width: 50%;">Tout les produits</b></h3>
	<div id="produits" class="container px-auto">
	<?php
	...
	{ 	// récupération des informations du produit
		...
		<div class="cards card py-0" style="width:275px;height:400px;">
			<div class="card-body">
			    ...
			    <div class="container">
			    	<img src="assets/<?php echo $image ?>" class="mx-auto d-block" alt=image style="height: 150px;" />
			    </div>
