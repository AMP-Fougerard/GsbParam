...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : ven. 14 oct. 2022 à 08:13
...
CREATE TABLE IF NOT EXISTS `administrateur` (
  ...
  `mdp` varchar(100) COLLATE utf8mb3_bin NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `categorie` (
  `id` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `libelle` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE IF NOT EXISTS `client` (
  `id` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `nom` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `prenom` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `adresseRue` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `cp` varchar(5) COLLATE utf8mb3_bin NOT NULL,
  `ville` varchar(32) COLLATE utf8mb3_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `contenir` (
  `id` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `id_produit` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `qte` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `effectuer` (
  `id` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `id_commande` varchar(32) COLLATE utf8mb3_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `produit` (
  `id` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `description` varchar(50) COLLATE utf8mb3_bin NOT NULL,
  `prix` decimal(10,2) NOT NULL,
  `image` varchar(100) COLLATE utf8mb3_bin NOT NULL,
  `id_categorie` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  PRIMARY KEY (`id`),
