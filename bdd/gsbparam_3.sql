...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 26 mai 2023 à 15:38
...
('a.fougerard@gmail.fr', '000001', '2023-05-23', 'E'),
('a.fougerard@gmail.fr', '000002', '2023-05-24', 'E'),
('a.fougerard@gmail.fr', '000003', '2023-05-24', 'E'),
('a.fougerard@gmail.fr', '000004', '2023-05-25', 'E');
...
CREATE TABLE IF NOT EXISTS `compte` (
  ...
  `prenom` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `rue` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `cp` varchar(5) COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `compte` (`mail`, `pass`, `nom`, `prenom`, `rue`, `cp`, `ville`, `admin`) VALUES
('Admin@gsbparam.com', '$2y$10$RyLMdG0233.hF7Casabl6Oaf4qMi93Um6kGDBBsjz7vaQ/xZiSLpC', 'Admin', '.', '.', '00000', '.', 1),
('a.fougerard@gmail.fr', '$2y$10$thuLWMDRfGPnO8St6vwu7OuojH9NbPmguDZO4ISoRvC.Z.pyvwahe', 'fougerard', 'antonin', '17 rue de la dent de lièvre', '45000', 'Saran', 0),
('michel.durand@gmail.fr', '$2y$10$C/pWLUQoSs8PiquJB84B0u3ZBNzUr5Q7pu36c4Q0dWMhGrfgfWH7i', 'Durand', 'Michel', 'XX rue du bout du monde', '00001', 'Perpertelesoies', 0);
...
INSERT INTO `contenir` (`id`, `id_contenance`, `mail_commande`, `id_commande`, `qte`) VALUES
('c01', 1, 'a.fougerard@gmail.fr', '000002', 2),
('c01', 1, 'a.fougerard@gmail.fr', '000003', 45),
('c01', 1, 'a.fougerard@gmail.fr', '000004', 2),
('c04', 1, 'a.fougerard@gmail.fr', '000001', 2),
('c05', 1, 'a.fougerard@gmail.fr', '000004', 1),
('f02', 2, 'a.fougerard@gmail.fr', '000002', 5),
('f05', 1, 'a.fougerard@gmail.fr', '000001', 1),
('p05', 1, 'a.fougerard@gmail.fr', '000001', 1);
...
('f08', 'test', 'test', 'images/gsbBioLogo0.png', '0000-00-00', 'FO', 2),
...
('p08', 'huile essentielle', 'flacon d\'huile essentielle d\'érable', 'images/pexels-photo-4465969.png', '0000-00-00', 'PS', 18);
...
('p06', 1, 6, 4, 50, 1, 3),
('p07', 1, 14, 30, 50, 1, 1),
('p08', 1, 25.99, 20, 5, 1, 1),
('p08', 2, 49.99, 40, 15, 0, 1),
('p08', 3, 75, 1, 20, 0, 2);
